...
void GMenu2X::setInputSpeed() {
	...
	input.setInterval(150, ACTION_START  ); //500
	input.setInterval(150, ACTION_SELECT ); //500
	input.setInterval(150, ACTION_X      ); //300
	input.setInterval(150,  ACTION_Y     ); //300
	input.setInterval(150,ACTION_B      ); //1000
	//joy.setInterval(1000,ACTION_CLICK  );
	input.setInterval(150, ACTION_L      ); //300
	input.setInterval(150, ACTION_R      ); //300
