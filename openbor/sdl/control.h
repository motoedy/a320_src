...
#include "joysticks.h"
	...
	#define	CONTROL_DEFAULT1_FIRE1		SDLK_LCTRL
	#define	CONTROL_DEFAULT1_FIRE2		SDLK_LSHIFT
	#define	CONTROL_DEFAULT1_FIRE3		SDLK_BACKSPACE
	#define	CONTROL_DEFAULT1_FIRE4		SDLK_TAB
	#define	CONTROL_DEFAULT1_FIRE5		SDLK_LALT  //jump
	#define	CONTROL_DEFAULT1_FIRE6		SDLK_SPACE //special
